...
//@interface FridayLunchObject : NSObject
//@end

@interface FridayLunchObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FridayLunchObject class]])
		{
			for (NSString *key in [[(FridayLunchObject*)o modules] allKeys])
			{
