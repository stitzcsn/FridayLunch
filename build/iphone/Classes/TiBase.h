...
// in simulator we redefine to format for FridayLunch Developer console
...
{\
	NSString * exceptionName = [@"org.fridaylunch." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fridaylunch";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIFridayLunchNativeItemNone = -1, 
	UIFridayLunchNativeItemSpinner = -2,
	UIFridayLunchNativeItemProgressBar = -3,
	
	UIFridayLunchNativeItemSlider = -4,
	UIFridayLunchNativeItemSwitch = -5,
	UIFridayLunchNativeItemMultiButton = -6,
	UIFridayLunchNativeItemSegmented = -7,
	
	UIFridayLunchNativeItemTextView = -8,
	UIFridayLunchNativeItemTextField = -9,
	UIFridayLunchNativeItemSearchBar = -10,
	
	UIFridayLunchNativeItemPicker = -11,
	UIFridayLunchNativeItemDatePicker = -12,
	
	UIFridayLunchNativeItemInfoLight = -13,
	UIFridayLunchNativeItemInfoDark = -14,
	
	UIFridayLunchNativeItemDisclosure = -15,
	
	UIFridayLunchNativeItemContactAdd = -16
};
